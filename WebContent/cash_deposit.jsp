...
<%
String c= new   purchase().sessions(request).getId();
...
<b><input     style=" background: #fff;width: 70%;"  
type="text" class="e3"  name="product"  
   value="Investment unit Review"   readonly="readonly" /></b>
</td>
</tr>
<tr>
<td>
...
value=" <%=resultSet.getString("shipping")%>"   
readonly="readonly"/>
...
value="<%=resultSet.getString(3) %>"   readonly="readonly" />
</td>
</tr>
<tr>
<td>
