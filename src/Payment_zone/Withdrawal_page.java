...
public class Withdrawal_page {
		...
		private String name="",reason="",user="",amount="";
		private String  
		Date_,
		Transciation_ID,
		Payment_method,
		...
		public String bal(HttpServletRequest  request1) {
			if(new purchase().sessions(request1).getAttribute("User1")!=null)
			    return new Auth_payment().pull_user_balance((String)new purchase().sessions(request1).getAttribute("User1"));
		return null;
		}
